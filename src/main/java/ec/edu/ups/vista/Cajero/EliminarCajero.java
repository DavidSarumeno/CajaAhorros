 ...
 * @author David
 */
public class EliminarCajero extends javax.swing.JFrame {
    ...
    private void txtCedula3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCedula3ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(new EliminarCajero(), "Esta Seguro que Desea eliminar", " Confirmar ", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
